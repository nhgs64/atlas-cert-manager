...
// +kubebuilder:rbac:groups=hvca.globalsign.com,resources=issuers;clusterissuers,verbs=get;list;watch
// +kubebuilder:rbac:groups=hvca.globalsign.com,resources=issuers/status;clusterissuers/status,verbs=get;update;patch
